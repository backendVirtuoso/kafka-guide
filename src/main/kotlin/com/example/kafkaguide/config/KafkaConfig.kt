package com.example.kafkaguide.config
...
class KafkaConfig {
    ...
    fun cdcConsumerFactory(): ConsumerFactory<String, String> {
        val props = mapOf(
            ...
            ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG to org.apache.kafka.common.serialization.StringDeserializer::class.java,
